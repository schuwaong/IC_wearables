...
def build_creator_prompt(result: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            "- Keep the same face scale, crop logic, head-to-body relationship, and hairstyle silhouette around the forehead, temples, ears, neck, and shoulders.",
            "- If the reference face is neutral or not smiling, do not add a smile, grin, visible teeth, or any new expression.",
            "- Do not beautify, slim, widen, age, de-age, change ethnicity, change eye colour, change hairstyle, change hairline, change hair part, add or remove hair volume, change facial hair, or alter the natural face proportions.",
            "- Keep the face angle, camera perspective, and head size close to the reference photo. Do not stretch, warp, liquify, smooth too much, or make the face look like a different person. If styling conflicts with identity preservation, identity preservation wins.",
